...
def mediapipe_static(dir_input, dir_output_image, dir_output_csv, name):
    ...
    with mp_face_mesh.FaceMesh(
        ...
        for idx, file in tqdm(enumerate(files, start=0)):
            ...
            try:
                cv2.imwrite(dir_output_image + str(idx) +
                            '.png', annotated_image)
...
mediapipe_static(r"C:\FaceExperience\valid\neutral\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\valid/",
                 "neutral")

mediapipe_static(r"C:\FaceExperience\valid\sad\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\valid/",
                 "sad")

mediapipe_static(r"C:\FaceExperience\valid\surprise\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\valid/",
                 "surprise")

mediapipe_static(r"C:\FaceExperience\train\angry\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\train/",
                 "angry")

mediapipe_static(r"C:\FaceExperience\train\disgust\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\train/",
                 "disgust")

mediapipe_static(r"C:\FaceExperience\train\fear\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\train/",
                 "fear")

mediapipe_static(r"C:\FaceExperience\train\happy\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\train/",
                 "happy")

mediapipe_static(r"C:\FaceExperience\train\neutral\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\train/",
                 "neutral")

mediapipe_static(r"C:\FaceExperience\train\sad\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\train/",
                 "sad")

mediapipe_static(r"C:\FaceExperience\train\surprise\*",
                 r"C:\mediapipe\image/",
                 r"C:\mediapipe\csv\train/",
                 "surprise")
